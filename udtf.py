#udfs - user defined function - custom logic row by row - one row at a time
#user defined table functions - custom logic on whole table - one can return many rows 
