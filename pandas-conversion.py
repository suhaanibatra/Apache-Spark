...
import os
os.environ['PYARROW_IGNORE_TIMEZONE'] = '1' #driver side
import pandas as pd
import pyspark.pandas as ps  # Alias for pandas API on Spark

#pandas is limited by how much memory it can handle, spark is limited by cluster 
